...
public class Library {
  ...
  public String lookup(long isbn) {
      ...
      //if(check if the parameter's isbn is equal to the book's isbn)
      // return library.get(i).getHolder;
  ...
  public boolean checkout(long isbn, String holder, int month, int day, int year) {
    ...
    //for(go through the library list)
      // if(the isbn in the parameter is in my list)
      //  if(check if library.get(i).getHolder() != null)
      //      return false;
      //  else
      //      GregorianCalendar dueDate= new GregorianCalendar(year, month, day);
      //      library.get(i).checkout(holder, dueDate);// this is coming from the LibraryBook
      //      return true;
